...
public class TreeSetQ3 {
    ...
    public static void main(String[] args) {
        ...
        s.add(new Employees ("Sara",123,50000,"Sar"));
        s.add(new Employees ("Gourav",456,60000,"HR"));
        s.add(new Employees ("Anand",789,30000,"Mgmt"));
        s.add(new Employees("Uday",111,90000,"Mgmt"));
        s.add(new Employees("Vinay",222,10000,"Vin"));
